...
`), 0o600); err != nil {
	...
	calls := 0
	orig := runTUIProgram
	runTUIProgram = func(_ *cobra.Command, _ tmuxctl.OneShot, _ string, _ tui.Focus, _, _ time.Duration, _, _, _ string) (tui.Model, error) {
		calls++
...
`), 0o600); err != nil {
	...
	runTUIProgram = func(_ *cobra.Command, _ tmuxctl.OneShot, initialHighlight string, initialFocus tui.Focus, _, _ time.Duration, _, _, _ string) (tui.Model, error) {
